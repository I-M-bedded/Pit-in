...
# Train vision model (COIN-Pose on YOLO26n-pose backbone)
python vision/yolo/train_coin_pose.py --phase 1 --epochs-p1 50 --batch-p1 4   # Phase 1: SSL warm-up
python vision/yolo/train_coin_pose.py --phase 2 --p1-ckpt runs/coin/phase1/best.pt --epochs-p2 30   # Phase 2: Task tuning
python vision/yolo/train_coin_pose.py --phase 12 --epochs-p1 50 --epochs-p2 30  # Both phases
